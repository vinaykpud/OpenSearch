...
public class DataFusionPlugin extends Plugin implements SearchBackEndPlugin<DatafusionReader>, AnalyticsSearchBackendPlugin {
    ...
    private SearchExecEngine createEngine(ExecutionContext ctx) {
        ...
        return new DatafusionSearchExecEngine(
            dfReader.getReaderHandle().getPointer(),
            ctx.getTableName(),
            ctx.getFragmentBytes(),
            dataFusionService.getNativeRuntime(),
            dataFusionService::newChildAllocator
        );
    }
