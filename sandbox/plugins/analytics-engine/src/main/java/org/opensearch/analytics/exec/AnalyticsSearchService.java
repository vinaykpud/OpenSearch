...
public class AnalyticsSearchService {
    ...
    public FragmentExecutionResponse executeFragment(
        ...
        // TODO: add canMatch() short-circuit before execution (see vanilla SearchService:825-838)
        ...
        try (GatedCloseable<Reader> gatedReader = readerProvider.acquireReader()) {
            ...
            try (SearchExecEngine engine = backend.getSearchExecEngineProvider().createSearchExecEngine(ctx)) {
    ...
    /**
     * Drains all batches from the result stream into a {@link FragmentExecutionResponse}.
